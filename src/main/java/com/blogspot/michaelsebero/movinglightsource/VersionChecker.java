...
public class VersionChecker implements Runnable
{
    ...
    public void run() 
    {
        ...
        try 
        {
            in = new URL("https://raw.githubusercontent.com/jabelar/MovingLightSource-1.12/master/src/main/java/com/blogspot/michaelsebero/movinglightsource/version_file").openStream();
        } 
        catch 
